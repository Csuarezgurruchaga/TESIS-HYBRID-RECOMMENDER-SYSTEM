...
class MemoryCollaborativeFilter:
    ...
    def adjusted_cosine_similarity(self, user_item_matrix, itemA, itemB):
        """
        ...
        for item1 in tqdm(idx_items, desc="Computing Similarities", unit="item"):
            ...
            for item2 in idx_items:
                ...
                if np.any(np.logical_and(user_item_matrix.loc[:, item1], user_item_matrix.loc[:, item2])): 
                    ...
                    similarity = self.adjusted_cosine_similarity(user_item_matrix, item1, item2) 
    ...
    def compute_neighbors(self, u, i, user_item_matrix):
        """
    ...
    def compute_prediction(self, u, user_item_matrix, i):
        """
        ...
        neighbors = self.compute_neighbors(u, i, user_item_matrix)
    ...
    def recommend(self, u, user_item_matrix, dict_map):
        """
        ...
        try :
            ...
            for i in items_to_predict:
                rating_predictions[i] = self.compute_prediction(u, user_item_matrix, i)
            ...
            print(f"Cold-Star Problem: el usuario no se encuentra registrado")
